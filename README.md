...
Test cases cover: direct override (ATK-001), system prompt leak (ATK-006), indirect email injection (ATK-002), compliance authority claim (ATK-004), memo field tampering (ATK-003), CEO impersonation (ATK-008), fast-follow abuse (ATK-012), context poisoning (ATK-005), velocity shaping (ATK-013), and 3 legitimate baseline scenarios.
